...
<head runat="server">
    ...
    <link href="css/walmart.css" rel="stylesheet" />
    <script src="javascript/walmart.js"></script>
    <script runat="server">  
        ...
        protected void saveProductWalmart_Click(object sender, EventArgs e)
        {
            string username = Session["curruser"].ToString();
        ...
        public static string loadSavedStores(string username)
        {
            ...
            var prodData = productDataAO.getByUsernameStore(username, "walmart");
...
<body ng-app="">
    ...
    <div class="container body-height">
        ...
        <div class="row" ng-controller="WalmartController">
            <div class="col-md-9">
                                <table class="table table-hover">
                    <tr class="row">
                        <td class="col-md-3">Name</td>
                        <td class="col-md-9">{{items[0].name}}</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Description</td>
                        <td class="col-md-9">{{items[0].shortDescription}}</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Image</td>
                        <td class="col-md-9"><img ng-src="{{items[0].thumbnailImage}}"/></td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Price</td>
                        <td class="col-md-9">${{items[0].salePrice}}</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Standard Shipping Rate</td>
                        <td class="col-md-9">${{items[0].standardShipRate}}</td>
                    </tr>    
                    <tr class="row">
                        <td class="col-md-3">Ratings</td>
                        <td class="col-md-9"><img ng-src="{{items[0].customerRatingImage}}"/></td>
                    </tr>            
                    <tr class="row">
                        <td class="col-md-3">Add to Walmart Cart (Please ensure you are logged on to your Walmart account)</td>
                        <td class="col-md-9"><a href="{{items[0].addToCartUrl}}" class="btn btn-primary">Click here</a></td>
                    </tr>                   
                </table>
            </div>
            <div class="col-md-3">
                <table class="table table-hover">
                    <thead class="row">
                        <tr class="col-md-12">
                            <th>Saved Products on Walmart</th>
                        </tr>
                    </thead>
                    <tbody class="row">
                        <tr class="col-md-12" ng-repeat="product in products">                       
                            <td class="text-left"><a href="walmart.aspx?title={{product.comparisonTextValue}}" target="_blank">{{product.comparisonTextValue}}</a></td>
                        </tr>
                    </tbody>                                       
                </table>
            </div>
        ...
        <form runat="server" id="form1" class="row pull-right">
            ...
            <asp:Button CssClass="btn btn-success btn-block" id="saveProductWalmart" name="saveProductWalmart" runat="server" Text="Save Product" onclick="saveProductWalmart_Click"/>
        </form>
